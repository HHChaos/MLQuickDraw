...
{
    public static class ModelBuilderV1
    {
        private static string MODEL_FILEPATH = @"MLModelV1.zip";
        ...
        {
            // Load Data
            IDataView trainingDataView = mlContext.Data.LoadFromTextFile<ModelInputV1>(
                                            path: trainDataPath,
                                            hasHeader: false,
                                            separatorChar: ',',
                                            allowQuoting: true,
